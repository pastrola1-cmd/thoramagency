            ...
            {benefits.map((b) => {
              ...
              return (
                <div key={b.title} className="glass p-6 rounded-2xl border border-steel/60 hover:border-cyan-border/20 transition-all duration-300">
                  <div className="w-10 h-10 rounded-xl bg-steel/20 border border-steel/50 text-cyan-400 flex items-center justify-center mb-4">
            ...
            {positions.map((pos) => (
              ...
              >
                <div>
                  ...
                  <div className="text-[10px] text-cyan-400 font-mono uppercase tracking-wider mb-2">
                    {pos.type}
                  </div>
              ...
              <form onSubmit={handleApply} className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 rounded-xl border border-steel bg-steel/10 text-ice focus:border-cyan-500 focus:ring-2 focus:ring-cyan-500/50 transition-all focus:outline-none text-body-xs"
                    required
                  />
                </div>
                <div>
