  ...
  return (
    <div className="py-24 sm:py-32">
      <div className="max-w-5xl mx-auto px-5 sm:px-8">
        ...
        <Link
          href="/services"
          className="inline-flex items-center gap-2 text-xs font-mono text-zinc-400 hover:text-cyan-400 transition-colors mb-10"
        >
        ...
        <div className="mb-16">
          ...
          <p className="text-base sm:text-lg text-cyan-400/90 font-mono mb-6">
            {service.tagline}
          </p>
          ...
          <div className="lg:col-span-7 p-8 rounded-2xl studio-glass space-y-6">
            ...
            <div className="space-y-4">
              {service.deliverables.map((del) => (
                <div key={del.name} className="p-4 rounded-xl bg-white/[0.02] border border-white/[0.05]">
        ...
        <div className="p-8 rounded-2xl studio-glass mb-16 flex flex-wrap items-center justify-between gap-4">
          <div className="flex flex-wrap items-center gap-2">
            ...
            {service.tech.map((t) => (
              <span
                key={t}
                className="text-xs font-mono px-3 py-1 rounded bg-white/[0.03] border border-white/[0.06] text-zinc-300"
              >
                {t}
              </span>
            ))}
